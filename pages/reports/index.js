...
const {brandWiseCondensedReport,
    ...
    allBrandWiseCondensedReport,
     dataFromLedgerStorage,showroomWiseSalesList,customerLedgerList, view_salesman, 
     ...
     out_standing_report,
     brandReportInsert, 
     view_salesman_chart,brandReportStorageInsert,brandWisePurchaseReport} = require('./salesReports');
const { PurchaseRegisterList,PurchaseJournalReport,out_standing_purchase } = require('./PurchaseRegister');
