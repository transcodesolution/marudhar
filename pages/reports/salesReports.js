...
const out_standing_report = async (req, res) => {
  ...
  let outStandingData = await customer.aggregate([
    ...
    {
      $addFields: {
        closingBalance: { $ifNull: [{ $round: [{ $first: "$store.closingBalance" }, 2] }, 0] },
        // {
        //   $switch:
        //   {
        //     branches: [
        ...
        //         case: {
        //           $and: [
        //             { $eq: [{ $first: "$store.closeCrDrStatus" }, "Dr"] },
        //             { $eq: [{ $first: "$store.openCrDrStatus" }, "Cr"] }
        //           ]
        //         },
        //         then: {
        //           $subtract: [
        //             { $first: "$store.closingBalance" },
        //             { $first: "$store.openingBalance" }
        //           ]
        //         }
        //       },
        //       {
        //         case: {
        //           $and: [
        //             { $eq: [{ $first: "$store.closeCrDrStatus" }, "Cr"] },
        //             { $eq: [{ $first: "$store.openCrDrStatus" }, "Dr"] }
        //           ]
        //         },
        //         then: {
        //           $subtract: [
        ...
        //       },
        //     ],
        //     default: { $ifNull: [{ $round: [{ $first: "$store.closingBalance" }, 2] }, 0] }
        //   }

        // },
        // $ifNull: [{ $round: [{ $first: "$store.closingBalance" }, 2] }, 0]

        openingBalance: { $ifNull: [{ $round: [{ $first: "$store.openingBalance" }, 2] }, 0] },
  ...
  //             }
  //           },
  //           { $project: { "invoice_item_details.net_value": 1,"invoice_item_details.invoice_no":1 } },
  //           {
  //             $group:{
  ...
  //     { $addFields: { invoiceNo: "$invoice1._id" } },
  //     { $unset: ["invoice1"] },
  //     // // //LOOKUP 3////////////////////////////////////////////////////////////////////////////////
  ...
  //     /////////////////////////////////////////
  //     { $addFields: { netValue:{
  //       $subtract: [ {$sum: [{$toDouble:"$sumInvoiceNetValue"},
  ...
  // // {
  // //   $addFields: {
  // //     txt_min_amount: Number(txt_min_amount)
  ...
  //     if: { 
  //       $and: [ 
  //    { $gte:["$closing_balance", Number(txt_min_amount)]},
  //    { $lte:["$closing_balance", Number(txt_max_amount)]}
  //       ] 
  //   },
