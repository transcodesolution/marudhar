...
const devmongoconfig = {
  mongoURI:
    "mongodb://127.0.0.1:27017/db_marudhar_live_backup?readPreference=primary&directConnection=true&ssl=false",
  //
};
  ...
  //////////////////////////////////////// login check 
    if (fy === "2022-2023") {
      ...
      if (process.env.NODE_ENV === "production" && betaFlag === false) {
        ...
        return mongo_config = devmongoconfig//prodmongoconfig; //devmongoconfig
      }
    }
    else {
      ...
      if (process.env.NODE_ENV === "production" && betaFlag === false) {
        ...
        return mongo_config = prodmongoconfigFy
        ...
        return mongo_config = devmongoconfig//devmongoconfig//prodmongoconfig
      }
    }
  }
